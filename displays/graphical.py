...
class PacmanDisplay:
    ...
    def make_window(self, width, height):
        ...
        begin_graphics(screen_width, screen_height, BACKGROUND_COLOR, "Pacumen")
    ...
    def draw_ghost(self, ghost, agentIndex):
        ...
        color = self.get_ghost_color(ghost, agentIndex)
...
class FirstPersonPacmanDisplay(PacmanDisplay):
    def __init__(self, zoom=1.0, show_ghosts=True, capture=False, frame_time=0):
        PacmanDisplay.__init__(self, zoom, frame_time=frame_time)
        self.show_ghosts = show_ghosts
        self.capture = capture

    def initialize(self, state, is_blue=False):
        self.is_blue = is_blue
        PacmanDisplay.start_graphics(self, state)
    ...
    def get_position(self, ghost_state):
        if not self.show_ghosts and not ghost_state.is_pacman and ghost_state.get_position()[1] > 1:
            ...
            return PacmanDisplay.get_position(self, ghost_state)
